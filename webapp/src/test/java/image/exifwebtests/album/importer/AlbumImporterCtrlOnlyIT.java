...
public class AlbumImporterCtrlOnlyIT {
	...
	static class Config {
		...
		@Bean
		AlbumImporterService albumImporterService(ImageHelper imageHelper, ImageImporterService imageImporterService, ImageStateService imageStateService, ImageQueryRepository imageQueryRepository, AlbumRepository albumRepository, AlbumTopic albumTopic, AlbumPathChecks albumPathChecks, AlbumHelper albumHelper, FileStoreService fileStoreService) throws IOException {
			var bean = spy(new AlbumImporterService(imageHelper, imageImporterService,
					imageStateService, imageQueryRepository, albumRepository, albumTopic,
